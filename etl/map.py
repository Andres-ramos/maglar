...
# Create stuff
def write_layer(local_layer_file_path: str, geojson: str) -> None:
    """
    Helper function
...
def upload_layer(
    gis: GIS, layer_title_name: str, local_layer_file_path: Path, storage_folder: str
) -> Item:
    """
...
def create_layer(
    ...
    return upload_layer(gis, layer_title_name, local_layer_file_path, storage_folder)
